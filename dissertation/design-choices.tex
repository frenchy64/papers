...
exceptions.
\emph{null} is explicitly expressible in Typed Clojure as the type \listline|nil|.
This enables more expressive types that specify where \emph{null} is and is not allowed.
