...
\begin{altgrammar}
  \exp{} &::=& (\exp{} \overrightarrow{\exp{}})         % function application, multiple arguments
...
\begin{tdisplay}{Evaluation Contexts}
  \begin{altgrammar}
    \E{} &::=& % application rules
              (\E{}\ \overrightarrow{\exp{}})  % target first
              \alt (\v{}\ \overrightarrow{\v{}}\ \E{}\ \overrightarrow{\exp{}}) % arguments next
              % map rules
