...
This is idea not new~\cite{Fag91,CF91,AM91}, but recent attempts~\cite{Tob10}
are noteworthy for their broad success in matching many of the advantages of statically typed
languages, notably due to the use of bidirectional checking~\cite{PT00}.
...
\begin{itemize}
  ...
  \item We identify major future issues in typing Clojure code. Multimethod definitions are problematic
...
These contributions support my thesis by using the prototype to check practical code
and 
