...
% Rowan
% You've missed some of the steps. Most importantly the move to program analysis
% techniques like Set Based Analysis (SBA) - which suffered from modularity issues
% due to the lack of declared intended types.
% Maybe quote Felleisen - "problem: Mr Spidey and friends infer brittle and large
% types; errors remain difficult to explain and fix"
...
OCaml-style extensible record types has been the subject of extensive research~\cite{Wan89,CM91,HP91}.
...
% Unions, intersections, and singletons all fit best with extrinsic types
% - this is one reason why they are similar
