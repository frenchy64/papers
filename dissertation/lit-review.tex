...
An intersection of types \lstinline|a| and \lstinline|b|, written \lstinline|(I a b)| in Typed Clojure,
can be used safely in both positions expecting type \lstinline|a|,
and positions expecting type \lstinline|b|.
Intuitively, \lstinline|(I a b)| is both of type \lstinline|a| \emph{and} \lstinline|b|.
A union of types \lstinline|a| and \lstinline|b| is \emph{either} of type \lstinline|a| or
\lstinline|b|, written \lstinline|(U a b)| in Typed Clojure,
and can be used safely in positions expecting a type that is \emph{both} type \lstinline|a|
and \lstinline|b|.
...
\end{verbatim}
Typed Racket also uses union types
