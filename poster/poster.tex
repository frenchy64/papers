...
\begin{description}
  ...
  \item[Associating keyword keys] \colorbox{codebg}{\lstinline|(assoc \{:a 1 :b 2\} :c 3)|} 
    associates entry with key \lstinline|:c|, and
        is of type \colorbox{yellow}{\lstinline{'\{:a Number :b Number :c Number\}}}
  \item[Dissociating keyword keys] \lstinline|(dissoc {:a 1 :b 2} :a)| dissociates entry with key \lstinline|:a|, and
        is of type \colorbox{yellow}{\lstinline|'\{:b Number\}|}
  \item[Keyword lookup] \lstinline|(get {:a 1 :b 2} :a)| returns the value corresponding to the key \lstinline|:a|, and
...
\begin{posterbox}[name=references,column=2,below=conclusion]{References}
  ...
  \begin{thebibliography}{1}\itemsep=-0.01em
    ...
    \bibitem{tob10:bnb}
    Tobin-Hochstadt, S.
    \newblock {T}yped {S}cheme: {F}rom {S}cripts to {P}rograms (2010)
